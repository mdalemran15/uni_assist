...
<div class="w3-display-top middle w3-center w3-padding-64 "><span class="w3-text-white w3-hide-small" style="font-size:100px"><br> SUST<br>University
    </span>
...
<div class="w3-container w3-padding-64 w3-red w3-grayscale w3-xlarge" id="about">
  <div class="w3-content">
    ...
    <p>Shahjalal University of Science and Technology also known as SUST is a state supported not-for-profit research university located in Sylhet, Bangladesh. It is the first university to adopt American credit system in Bangladesh.SUST is traditionally known for research and education in the physical sciences and engineering. It is one of the most selective higher learning institutions, and received 41,285 undergraduate applicants for 2015-2016 session only admitting 1,448; an acceptance rate of 3.51%.</p>
...
<div class="w3-container w3-padding-64 w3-red w3-grayscale w3-xxlarge w3-center" id="link"> 
  ...
  <p>For Admission Click Here <a href="http://www.sust.edu/admission/undergraduate-admission" title="W3.CSS" target="_blank" class="w3-hover-text-red">Link</a></p>
</div>
</body>
</html>