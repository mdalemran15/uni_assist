...
<div class="w3-display-top middle w3-center w3-padding-64 "><span class="w3-text-white w3-hide-small" style="font-size:100px"><br> Dhaka<br>University
    </span>
...
<div class="w3-container w3-padding-64 w3-red w3-grayscale w3-xlarge" id="about">
  <div class="w3-content">
    ...
    <p>The University of Dhaka, is the oldest university in modern Bangladesh. The university is ranked number one on the Bangladesh University Ranking 2017.Today, it is the largest public university in Bangladesh, with a student body of 33,000 and a faculty of 1,800. It was identified by AsiaWeek as one of the top 100 universities in Asia.</p>
...
<div class="w3-container w3-padding-64 w3-red w3-grayscale w3-xxlarge w3-center" id="link"> 
  ...
  <p>For Admission Click Here <a href="http://admission.eis.du.ac.bd/" title="W3.CSS" target="_blank" class="w3-hover-text-red">Link</a></p>
</div>
</body>
</html>