...
<div class="w3-display-top middle w3-center w3-padding-64 "><span class="w3-text-white w3-hide-small" style="font-size:100px"><br> BUP<br>University
    </span>
...
<div class="w3-container w3-padding-64 w3-red w3-grayscale w3-xlarge" id="about">
  <div class="w3-content">
    ...
    <p>Bangladesh University of Professionals is one of the newest public universities of the country established on 5 June 2008. It is a Bangladesh Army supported public university.It awards bachelor's degrees in 10 categories. It awards master's degrees in 25 categories in , Business as well as Military & War studies. It also awards M. Phil degrees.</p>
...
<div class="w3-container w3-padding-64 w3-red w3-grayscale w3-xxlarge w3-center" id="link"> 
  ...
  <p>For Admission Click Here <a href="http://bup.edu.bd/notice_all.php" title="W3.CSS" target="_blank" class="w3-hover-text-red">Link</a></p>
</div>
</body>
</html>