...
<html>
<title>Chittagong University</title>
<meta charset="UTF-8">
...
<div class="w3-display-top middle w3-center w3-padding-64 "><span class="w3-text-white w3-hide-small" style="font-size:100px"><br> Chittagong<br>University
    </span>
...
<div class="w3-container w3-padding-64 w3-red w3-grayscale w3-xxlarge w3-center" id="link"> 
  ...
  <p>For Admission Click Here <a href="http://www.cu.ac.bd/ctguni/" title="W3.CSS" target="_blank" class="w3-hover-text-red">Link</a></p>
</div>
</body>
</html>